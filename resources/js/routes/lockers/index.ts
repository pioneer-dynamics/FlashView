...
/**
* @see \App\Http\Controllers\LockerController::renew
...
/**
* @see \App\Http\Controllers\LockerController::settings
* @see app/Http/Controllers/LockerController.php:223
* @route '/lockers/{accountId}/settings'
*/
export const settings = (args: { accountId: string | number } | [accountId: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
...
* @route '/lockers/{accountId}/settings'
*/
settings.url = (args: { accountId: string | number } | [accountId: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { accountId: args }
    }
...
* @route '/lockers/{accountId}/settings'
*/
settings.patch = (args: { accountId: string | number } | [accountId: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: settings.url(args, options),
    method: 'patch',
})
...
const lockers = {
    ...
    renew: Object.assign(renew, renew62224c),
    store: Object.assign(store, store),
    authInfo: Object.assign(authInfo, authInfo),
    ...
    downloadUrl: Object.assign(downloadUrl, downloadUrl),
    upgradeAuth: Object.assign(upgradeAuth, upgradeAuth),
}
