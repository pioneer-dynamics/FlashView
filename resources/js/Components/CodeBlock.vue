...
<div class="w-full">
    <div class="relative">
        ...
        <code class="ph-no-capture col-span-6 bg-gray-50 border border-gray-300 text-gray-700 text-sm rounded-lg focus:ring-gamboge-500 focus:border-gamboge-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-200 dark:focus:ring-gamboge-500 dark:focus:border-gamboge-500 whitespace-pre-wrap" disabled readonly>
