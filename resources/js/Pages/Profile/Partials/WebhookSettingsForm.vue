        ...
        <template #form>
            <div class="col-span-6">
                ...
                <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                    ...
                    <Link :href="route('webhooks.index')" prefetch class="underline text-sm text-gamboge-300 dark:text-gamboge-200 hover:text-gamboge-200 dark:hover:text-gamboge-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gamboge-500 dark:focus:ring-offset-gray-900">
                        Learn more
                    </Link>
                </p>
            </div>
