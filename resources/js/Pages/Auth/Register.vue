    ...
    <AuthenticationCardWithFeatures>
        ...
        <form @submit.prevent="submit">
            ...
            <div class="flex items-center justify-end mt-4">
                <Link :href="route('login')" prefetch class="underline text-sm text-gamboge-300 dark:text-gamboge-200 hover:text-gamboge-200 dark:hover:text-gamboge-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gamboge-500 dark:focus:ring-offset-gray-900">
                    Already registered?
                </Link>
