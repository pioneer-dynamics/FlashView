    ...
    <div>
        ...
        <DialogModal :show="displayingToken" @close="displayingToken = false">
            ...
            <template #content>
                ...
                <div v-if="$page.props.jetstream.flash.token" class="mt-4 bg-gray-100 dark:bg-gray-900 dark:shadow-neon-cyan-sm px-4 py-2 rounded font-mono text-sm text-gray-500 break-all">
